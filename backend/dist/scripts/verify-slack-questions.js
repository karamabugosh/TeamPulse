...
async function main() {
    ...
    const collection = app.get(collection_service_1.CollectionService);
    ...
    const newOrder = ((_a = maxOrder._max.order) !== null && _a !== void 0 ? _a : 0) + 1;
...
//# sourceMappingURL=verify-slack-questions.js.map